...
@Deprecated(
    ...
    replaceWith = ReplaceWith("amap(f)", "com.rajk2007.zcast.amap"),
...
@Deprecated(
    "This blocks with runBlocking, and should not be used inside a suspended context",
    replaceWith = ReplaceWith("amapIndexed(f)", "com.rajk2007.zcast.amapIndexed"),
    level = DeprecationLevel.ERROR
)
@Throws(CancellationException::class)
...
@Deprecated(
    "This blocks with runBlocking, and should not be used inside a suspended context",
    replaceWith = ReplaceWith("runAllAsync(transforms)", "com.rajk2007.zcast.runAllAsync"),
    level = DeprecationLevel.ERROR
)
@Throws(CancellationException::class)
fun <R> argamap(
