...
import com.rajk2007.zcast.plugins.PLUGINS_KEY
import com.rajk2007.zcast.plugins.PLUGINS_KEY_LOCAL
import com.rajk2007.zcast.syncproviders.AccountManager
import com.rajk2007.zcast.syncproviders.providers.AniListApi.Companion.ANILIST_CACHED_LIST
import com.rajk2007.zcast.syncproviders.providers.MALApi.Companion.MAL_CACHED_LIST
import com.rajk2007.zcast.syncproviders.providers.KitsuApi.Companion.KITSU_CACHED_LIST
import com.rajk2007.zcast.utils.Coroutines.ioSafe
import com.rajk2007.zcast.utils.Coroutines.main
import com.rajk2007.zcast.utils.DataStore.getDefaultSharedPrefs
import com.rajk2007.zcast.utils.DataStore.getSharedPrefs
import com.rajk2007.zcast.utils.DataStore.mapper
import com.rajk2007.zcast.utils.UIHelper.checkWrite
import com.rajk2007.zcast.utils.UIHelper.requestRW
import com.rajk2007.zcast.utils.downloader.VideoDownloadManager.setupStream
import com.rajk2007.zcast.utils.downloader.DownloadObjects
import com.rajk2007.zcast.utils.downloader.DownloadQueueManager.QUEUE_KEY
import com.rajk2007.zcast.utils.downloader.VideoDownloadManager.KEY_DOWNLOAD_INFO
import com.rajk2007.zcast.utils.downloader.VideoDownloadManager.KEY_RESUME_IN_QUEUE
import com.rajk2007.zcast.utils.downloader.VideoDownloadManager.KEY_RESUME_PACKAGES
...
object BackupUtils {
    ...
    /**
     * Copy of [com.rajk2007.zcast.utils.downloader.VideoDownloadManager.basePathToFile], [com.rajk2007.zcast.utils.downloader.VideoDownloadManager.getDefaultDir] and [com.rajk2007.zcast.utils.downloader.VideoDownloadManager.getBasePath]
