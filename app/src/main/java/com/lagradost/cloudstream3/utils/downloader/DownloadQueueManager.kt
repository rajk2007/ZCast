...
import com.rajk2007.zcast.ZCastApp.Companion.getKeys
import com.rajk2007.zcast.ZCastApp.Companion.removeKeys
import com.rajk2007.zcast.ZCastApp.Companion.setKey
import com.rajk2007.zcast.MainActivity.Companion.lastError
import com.rajk2007.zcast.mvvm.safe
import com.rajk2007.zcast.plugins.PluginManager
import com.rajk2007.zcast.services.DownloadQueueService
import com.rajk2007.zcast.services.DownloadQueueService.Companion.downloadInstances
...
import com.rajk2007.zcast.utils.downloader.VideoDownloadManager.downloadStatus
import com.rajk2007.zcast.utils.downloader.VideoDownloadManager.downloadStatusEvent
import com.rajk2007.zcast.utils.downloader.VideoDownloadManager.getDownloadFileInfo
import com.rajk2007.zcast.utils.downloader.VideoDownloadManager.getDownloadQueuePackage
import com.rajk2007.zcast.utils.downloader.VideoDownloadManager.getDownloadResumePackage
...
object DownloadQueueManager {
     ...
     * @see com.rajk2007.zcast.services.DownloadQueueService.Companion.downloadInstances
     */
    ...
    fun addToQueue(downloadQueueWrapper: DownloadQueueWrapper) = safe {
        val context = ZCastApp.context ?: return@safe
