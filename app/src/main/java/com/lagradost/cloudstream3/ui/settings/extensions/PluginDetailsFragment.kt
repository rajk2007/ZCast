...
import com.rajk2007.zcast.databinding.FragmentPluginDetailsBinding
import com.rajk2007.zcast.plugins.PluginManager
import com.rajk2007.zcast.plugins.VotingApi.canVote
import com.rajk2007.zcast.plugins.VotingApi.getVotes
import com.rajk2007.zcast.plugins.VotingApi.hasVoted
import com.rajk2007.zcast.plugins.VotingApi.vote
import com.rajk2007.zcast.R
import com.rajk2007.zcast.ui.BaseBottomSheetDialogFragment
    ...
    override fun onBindingCreated(binding: FragmentPluginDetailsBinding) {
        ...
        binding.apply {
            ...
            if (data.isDownloaded) {
                ...
                val plugin =
                    (PluginManager.urlPlugins[metadata.url] ?: PluginManager.plugins[metadata.url]) as? com.rajk2007.zcast.plugins.Plugin
