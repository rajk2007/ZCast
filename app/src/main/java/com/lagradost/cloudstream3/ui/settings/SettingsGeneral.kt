...
import com.rajk2007.zcast.databinding.AddRemoveSitesBinding
import com.rajk2007.zcast.databinding.AddSiteInputBinding
...
import com.rajk2007.zcast.ui.settings.Globals.beneneCount
...
import com.rajk2007.zcast.utils.BatteryOptimizationChecker.isAppRestricted
import com.rajk2007.zcast.utils.BatteryOptimizationChecker.showBatteryOptimizationDialog
...
import com.rajk2007.zcast.utils.downloader.DownloadFileManagement
...
class SettingsGeneral : BasePreferenceFragmentCompat() {
    ...
    companion object {
        fun Fragment.pickDownloadPath(uri: Uri?, path: String?) {
            ...
            val context = context ?: ZCastApp.context ?: return
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        getPref(R.string.dns_key)?.setOnPreferenceClickListener {
            ...
            activity?.showBottomDialog(
                ...
                (context ?: ZCastApp.context)?.let { ctx -> app.initClient(ctx) }
            }
            return@setOnPreferenceClickListener true
        }
