...
import com.rajk2007.zcast.databinding.FragmentResultSwipeBinding
import com.rajk2007.zcast.databinding.ResultRecommendationsBinding
import com.rajk2007.zcast.databinding.ResultSyncBinding
...
import com.rajk2007.zcast.ui.download.DOWNLOAD_ACTION_DOWNLOAD
import com.rajk2007.zcast.ui.download.DOWNLOAD_ACTION_LONG_CLICK
import com.rajk2007.zcast.ui.download.DownloadButtonSetup
import com.rajk2007.zcast.ui.player.CS3IPlayer
import com.rajk2007.zcast.ui.player.CSPlayerEvent
import com.rajk2007.zcast.ui.player.IPlayer
import com.rajk2007.zcast.ui.player.PlayerView
import com.rajk2007.zcast.ui.player.source_priority.QualityProfileDialog
import com.rajk2007.zcast.ui.quicksearch.QuickSearchFragment
import com.rajk2007.zcast.ui.result.ResultFragment.bindLogo
import com.rajk2007.zcast.ui.result.ResultFragment.getStoredData
import com.rajk2007.zcast.ui.result.ResultFragment.updateUIEvent
import com.rajk2007.zcast.ui.search.SearchAdapter
import com.rajk2007.zcast.ui.search.SearchHelper
import com.rajk2007.zcast.ui.setRecycledViewPool
import com.rajk2007.zcast.ui.settings.SettingsGeneral.Companion.pickDownloadPath
import com.rajk2007.zcast.ui.settings.utils.getChooseFolderLauncher
...
import com.rajk2007.zcast.utils.AppContextUtils.openBrowser
...
import com.rajk2007.zcast.utils.BatteryOptimizationChecker.openBatteryOptimizationSettings
...
import com.rajk2007.zcast.utils.SingleSelectionHelper.showBottomDialogInstant
...
import com.rajk2007.zcast.utils.UIHelper.popCurrentPage
import com.rajk2007.zcast.utils.UIHelper.populateChips
import com.rajk2007.zcast.utils.UIHelper.popupMenuNoIconsAndNoStringRes
import com.rajk2007.zcast.utils.UIHelper.setListViewHeightBasedOnItems
...
import com.rajk2007.zcast.utils.downloader.VideoDownloadManager
            ...
            resultSubscribe.setOnClickListener {
                viewModel.toggleSubscriptionStatus(context) { newStatus: Boolean? ->
                    ...
                    val name = (viewModel.page.value as? Resource.Success)?.value?.title
                        ?: com.rajk2007.zcast.utils.txt(R.string.no_data)
                            .asStringNull(context) ?: ""
                    showToast(
                        com.rajk2007.zcast.utils.txt(message, name),
                        Toast.LENGTH_SHORT
                    )
                }
        ...
        observe(viewModel.page) { data ->
            ...
            resultBinding?.apply {
                ...
                resultTitle.setOnLongClickListener {
                    clipboardHelper(
                        com.rajk2007.zcast.utils.txt(R.string.title),
                        resultTitle.text
                    )
                    true
                }
