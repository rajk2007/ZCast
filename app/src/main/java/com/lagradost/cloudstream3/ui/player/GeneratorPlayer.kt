...
import com.rajk2007.zcast.ZCastApp
...
import com.rajk2007.zcast.databinding.DialogOnlineSubtitlesBinding
import com.rajk2007.zcast.databinding.FragmentPlayerBinding
import com.rajk2007.zcast.databinding.PlayerSelectSourceAndSubsBinding
import com.rajk2007.zcast.databinding.PlayerSelectTracksBinding
import com.rajk2007.zcast.isAnimeOp
import com.rajk2007.zcast.isEpisodeBased
import com.rajk2007.zcast.isLiveStream
import com.rajk2007.zcast.isMovieType
...
import com.rajk2007.zcast.subtitles.AbstractSubtitleEntities
import com.rajk2007.zcast.subtitles.AbstractSubtitleEntities.SubtitleSearch
import com.rajk2007.zcast.syncproviders.AccountManager.Companion.subtitleProviders
import com.rajk2007.zcast.ui.download.DownloadButtonSetup
import com.rajk2007.zcast.ui.player.CS3IPlayer.Companion.preferredAudioTrackLanguage
import com.rajk2007.zcast.ui.player.CustomDecoder.Companion.updateForcedEncoding
import com.rajk2007.zcast.ui.player.PlayerSubtitleHelper.Companion.toSubtitleMimeType
import com.rajk2007.zcast.ui.player.source_priority.LinkSource
...
import com.rajk2007.zcast.ui.result.ACTION_CLICK_DEFAULT
import com.rajk2007.zcast.ui.result.EpisodeAdapter
import com.rajk2007.zcast.ui.result.FOCUS_SELF
import com.rajk2007.zcast.ui.result.ResultEpisode
import com.rajk2007.zcast.ui.result.ResultFragment
...
import com.rajk2007.zcast.ui.subtitles.SUBTITLE_AUTO_SELECT_KEY
import com.rajk2007.zcast.ui.subtitles.SubtitlesFragment
import com.rajk2007.zcast.ui.subtitles.SubtitlesFragment.Companion.getAutoSelectLanguageTagIETF
import com.rajk2007.zcast.utils.AppContextUtils.getShortSeasonText
...
import com.rajk2007.zcast.utils.Coroutines.runOnMainThread
...
import com.rajk2007.zcast.utils.SubtitleHelper.fromTagToLanguageName
import com.rajk2007.zcast.utils.SubtitleHelper.languages
...
import com.rajk2007.zcast.utils.UIHelper.hideSystemUI
    ...
    private val subsPathPicker =
        registerForActivityResult(ActivityResultContracts.OpenDocument()) { uri ->
            safe {
                ...
                val ctx = context ?: ZCastApp.context ?: return@safe
