...
import com.rajk2007.zcast.mapper
...
import com.rajk2007.zcast.syncproviders.AuthLoginPage
import com.rajk2007.zcast.syncproviders.AuthPinData
import com.rajk2007.zcast.syncproviders.AuthToken
...
import com.rajk2007.zcast.utils.DataStoreHelper.toYear
    ...
    private object SimklCache {
        ...
        fun cleanOldCache() {
            getKeys(SIMKL_CACHE_KEY)?.forEach {
                val isOld = ZCastApp.getKey<SimklCacheWrapper<Any>>(it)?.isFresh() == false
                if (isOld) {
                    removeKey(it)
                }
            }
